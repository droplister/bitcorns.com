<form role="form" method="POST" action="{{ route('farm.update', ['farm' => $farm->slug]) }}">
    ...
    <div class="row">
        <div class="form-group col-sm-6">
            ...
            <input id="latitude" type="text" class="form-control{{ $errors->has('latitude') ? ' is-invalid' : '' }}" name="latitude" value="{{ old('latitude') ? old('latitude') : $player->mapMarker->latitude }}">
        ...
        <div class="form-group col-sm-6">
            ...
            <input id="longitude" type="text" class="form-control{{ $errors->has('longitude') ? ' is-invalid' : '' }}" name="longitude" value="{{ old('longitude') ? old('longitude') : $player->mapMarker->longitude }}">
    ...
    <div class="form-group">
        ...
        <input id="message" type="text" class="form-control{{ $errors->has('message') ? ' is-invalid' : '' }}" name="message" value="BITCORN {{ $farm->xcp_core_address }}" required>
