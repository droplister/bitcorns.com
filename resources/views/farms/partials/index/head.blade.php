<div class="dropdown float-right mt-3 show">
    ...
    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuLink">
        ...
        <a class="dropdown-item" href="{{ route('farms.index', ['sort' => 'cards']) }}">
            <i class="fa fa-{{ $sort === 'cards' ? 'check-' : '' }}circle-o mr-1"></i>
            Cards
        </a>
        <a class="dropdown-item" href="{{ route('farms.index', ['sort' => 'crops']) }}">
            <i class="fa fa-{{ $sort === 'crops' ? 'check-' : '' }}circle-o mr-1"></i>
            Crops
        </a>
        <a class="dropdown-item" href="{{ route('farms.index', ['sort' => 'bitcorn']) }}">
        ...
        <a class="dropdown-item" href="{{ route('farms.index', ['sort' => 'oldest']) }}">
            <i class="fa fa-{{ $sort === 'oldest' ? 'check-' : '' }}circle-o mr-1"></i>
            Oldest
        </a>
        <a class="dropdown-item" href="{{ route('farms.index', ['sort' => 'newest']) }}">
            <i class="fa fa-{{ $sort === 'newest' ? 'check-' : '' }}circle-o mr-1"></i>
            Newest
        </a>
        <a class="dropdown-item" href="{{ route('farms.index', ['sort' => 'updated']) }}">
        ...
        <a class="dropdown-item" href="{{ route('farms.index', ['sort' => 'no-crops']) }}">
